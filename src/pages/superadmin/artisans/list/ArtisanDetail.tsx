			...
			<div className="grid p-8 bg-white  rounded-lg gap-[10rem]">
				...
				<section>
					...
					<div
						...
						style={{
							boxShadow: "0px 12.6316px 31.5789px rgba(102, 104, 105, 0.15)",
						}}
					>
						...
						<div className="grid gap-8">
							...
							<p className="text-[1.8rem]">
								...
								optio labore autem provident, dolore dolorum dicta vel tempore
								voluptatibus deserunt recusandae porro deleniti dolores illum,
								temporibus eveniet earum. Ducimus, repellendus? Lorem ipsum
								dolor sit amet consectetur adipisicing elit. Quos adipisci
								voluptatem molestias, obcaecati molestiae veritatis libero
								eveniet porro accusamus, reiciendis facilis. Illum et doloremque
								fuga quo aut laudantium consequatur nemo.
							</p>
						</div>
					</div>
				</section>
