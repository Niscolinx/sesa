...
function EditResident() {
    ...
    const {
        ...
        editResidentUser,
        setEditResidentUser,
    } = useContext(EditHouseholdContext)
    const [dialogType, setDialogType] = useState<DialogType>()
    const [dialogDetailType, setDialogDetailType] = useState<DetailDialogType>()
    const [editResidentUserCount, setEditResidentUserCount] = useState(2)
                        ...
                        <div className='grid gap-8'>
                            ...
                            <div>
                                ...
                                <p className='max-w-[30rem]'>
                                    10, Editress Street, Editress Avenue, Lagos,
                                    Nigeria.
                                </p>{' '}
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div>
                            <Select
                                ...
                                label='Edit Caretaker/Property Admin (optional)'
                                isSearchable
                    ...
                    <section className='mt-[5rem] grid gap-16'>
                                    ...
                                    return (
                                        <div key={idx}>
                                            <MappedSelect
                                                ...
                                                isSearchable
                                                color={'bg-[#076AFF]'}
                                                selectedState={editResidentUser}
                                                setSelectedState={
                                                    setEditResidentUser
                                                }
                                            />
                        ...
                        <div className='col-span-full rounded-lg border border-width-[.2rem] border-dashed border-color-grey-1 p-8 text-[1.6rem] relative w-full flex justify-items-center justify-center  max-w-[70%] mx-auto'>
                            <button
                                ...
                                onClick={() =>
                                    setEditResidentUserCount((prev) => prev + 1)
                                }
                            >
                                <span>
                                    <GrEdit />
