...
// 			<form
// 				// onSubmit={onSubmit}
// 				className="basis-full md:basis-1/2 px-10 py-20 flex flex-col justify-center md:px-20 xl:px-32 2xl:landscape:px-40 2xl:landscape:py-24"
// 			>
// 				<div>
// 					<h1 className="text-[4.5rem] font-Satoshi-ExtraBold">
// 						Welcome back!
...
// 					</div>
// 				</div>
// 				<button className="btn bg-[#0556E5] text-white rounded-lg py-4 mt-10 self-center md:self-start">
// 					{isLoading ? "Loading..." : "Login"}
// 				</button>
// 			</form>
// 			<div className="basis-full md:basis-1/2 md:landscape:basis-2/3">
// 				<img
// 					src="/img/hero.png"
// 					alt=""
// 					className="hidden md:block md:landscape:block bg-no-repeat bg-center w-full h-full"
// 				/>
// 			</div>
// 		</div>
// 	);
