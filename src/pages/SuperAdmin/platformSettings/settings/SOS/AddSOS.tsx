...
const Login = () => {
    ...
    const handleSubmit = (event:ChangeEvent<HTMLInputElement>) => {
      ...
      if (name !== "admin") {
        setClassName('input input-bordered input-error')
      } else if (pass !== "vaidik@219") {
        setClassName('input input-bordered input-error')
      } else {
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              <div className="form-control">
                ...
                <input id='floatingInput' type="text" placeholder="Username" className={className} value={name} onChange={(e) => setName(e.target.value)}/>
              </div>
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Password</span>
                </label>
                <input id='floatingPassword' type="password" placeholder="Password" value={pass} className={className} onChange={(e) => setPass(e.target.value)} />
              </div>
              <div className="form-control mt-6">
                <button className="btn btn-outline no-animation btn-warning" type="submit">Login</button>
              </div>
            </form>
          </div>
        </div>
