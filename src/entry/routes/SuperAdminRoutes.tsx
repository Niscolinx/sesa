...
const SuperAdminRoutes = (
	<Route path="/superAdmin" element={<Dashboard type='superAdmin' />} errorElement={<ErrorBoundary />}>
		...
		/>
		<Route path="resident-user-package/view/:id" element={<ViewPackage />} />
		...
		<Route path="wallet/commission/:id" element={<CommissionWalletDetails />} />
