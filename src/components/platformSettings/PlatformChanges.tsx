...
const PlatformChanges = () => {
    ...
    const [isPlatformChanges, setIsPlatformChanges] = useState(true)
    ...
    const handleOpen = (modalState: DialogType) => {
        if (modalState === 'validate') {
            setIsPlatformChanges(true)
        } else {
            setIsPlatformChanges(false)
        }
                            ...
                            <div className='bg-white rounded-2xl grid place-content-center justify-items-center h-[30rem] gap-8 text-[1.6rem]'>
                                ...
                                <div className='flex w-full justify-center gap-8'>
                                    ...
                                    <button
                                        ...
                                        onClick={confirmPlatformChanges}
                                    >
                                        Ok
                                    </button>
                                </div>
