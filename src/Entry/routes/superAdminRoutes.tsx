...
import AddProperty from '../../pages/SuperAdmin/platformSettings/AddProperty'
import AddSOS from '../../pages/SuperAdmin/platformSettings/AddSOS'
import SOSDetails from '../../pages/SuperAdmin/platformSettings/SOSDetails'
