...
import SecurityGuard from '../../pages/estatemanager/securityGuards/SecurityGuard'
import AddSecurityGuard from '../../pages/estatemanager/securityGuards/AddSecurityGuard'
import EditSecurityGuard from '../../pages/estatemanager/securityGuards/EditSecurityGuard'
import ViewSecurityGuard from '../../pages/estatemanager/securityGuards/ViewSecurityGuard'
